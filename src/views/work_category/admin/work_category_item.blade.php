...
<div class="row margin-bottom-12">
    <div class="col-md-12">
        <a href="{!! URL::route('admin_work_category.edit') !!}" class="btn btn-info pull-right">
            <i class="fa fa-plus"></i>{{trans('site::work_category_admin.work_category_add_button')}}
        </a>
    </div>
</div>
...
<table class="table table-hover">
    <thead>
        <tr>
            <td style='width:5%'>
                {{ trans('site::work_category_admin.order') }}
            </td>

            <th style='width:5%'>
                {{ trans('site::work_category_admin.category_id') }}
            </th>

            <th style='width:30%'>
                {{ trans('site::work_category_admin.category_name') }}
            </th>

            <th style='width:30%'>
                {{ trans('site::work_category_admin.category_parent') }}
            </th>

            <th style='width:15%'>
                {{ trans('site::work_category_admin.operations') }}
            </th>
        </tr>
    </thead>
    <tbody>
...
<span class="text-warning">
    <h5>
        {{ trans('site::work_category_admin.message_find_failed') }}
    </h5>
</span>
<!-- /END FIND MESSAGE -->
@endif
